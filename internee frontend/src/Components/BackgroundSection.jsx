...
const BackgroundSection = ({h3,h1,pgname}) => {
  ...
  return (
    <section className="bg-green-500 text-white h-screen  p-16 lg:pl-60  flex justify-center lg:justify-start items-end" style={{backgroundImage:`url( ${backgroundimage})`,backgroundSize: '50%', backgroundRepeat:'no-repeat' ,backgroundPosition:'right'}}>
